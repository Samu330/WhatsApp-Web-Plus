const main = () => {
    ...
    const revoke_handler = (message) => {
        ...
        // Mantener el mensaje y mostrar que se ha eliminado
        message.type = "chat";
        ...
        return false; // Evitar crear un nuevo mensaje
    };
    ...
    const handle_edited_message = function () {
        ...
        const updatedMessageContent = `✏️ _Este mensaje ha sido editado:_\n\n*Anterior:* ${message?.caption}\n*Nuevo:* ${message?.body || message?.caption}`;

        // Lógica para encontrar y modificar el mensaje original en el DOM
